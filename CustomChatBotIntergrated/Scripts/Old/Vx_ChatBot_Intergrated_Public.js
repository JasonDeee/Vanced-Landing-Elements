...
// Workers Endpoints
const Vx_WORKERS_ENDPOINT = document.currentScript.getAttribute(
  "Vx_WORKERS_ENDPOINT"
);
// Request Types Enum
...
function Vx_UpdateChatDisplay(chatHistory) {
  try {
    ...
    let chatContainerPending = document.getElementById("Vx_chatContainer");

    // Xóa toàn bộ tin nhắn cũ (nếu có)
    chatContainer.innerHTML = "";
    chatContainerPending.innerHTML = "";
    ...
    chatContainerPending.classList.remove("Pending");
